        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gray-50 rounded-2xl p-8 lg:p-12 border border-gray-100 lg:flex lg:justify-between lg:items-center gap-8 shadow-sm">
            <div className="mb-8 lg:mb-0 lg:w-1/3 flex flex-col items-center text-center">
              ...
              <a href="https://barilga.mn" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-4 hover:opacity-80 transition-opacity w-64" title="BARILGA.MN">
                <div className="h-44 w-44 lg:h-56 lg:w-56 flex items-center justify-center">
