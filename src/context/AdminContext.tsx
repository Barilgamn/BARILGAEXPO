...
export const seminarProgram: ProgramDay[] = [
  {
    ...
    events: [
      ...
      { time: '14:25', title: 'Барилга, байгууламжийн норм дүрмийг өгөгдөл болгон хувиргаж, ашиглах нь', desc: 'Э.Мягмар-Өлзий — Цахим хөгжил, мэдээллийн технологийн хэлтсийн дарга', loc: LOC },
      { time: '14:50', title: 'Нийслэл Улаанбаатар хотод хэрэгжиж буй томоохон төслүүд', desc: 'Д.Төгөлдөр — "Нэгдсэн төслийн удирдлагын газар" ОНӨТҮГ, ахлах инженер', loc: LOC },
      { time: '15:10', title: 'Дахин төлөвлөлт ба Улаанбаатар хотын шинэ өнгө төрх', desc: 'Б.Пүрэвсүрэн — "Улаанбаатар орон сууцжуулалт" ХХК-ийн Захиргаа, санхүүгийн газрын дарга', loc: LOC },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '12:15', title: 'Амины орон сууцны зөв төлөвлөлт: Газрын сонголтоос барилгын гүйцэтгэл хүртэл', desc: 'Б.Нандинцэцэг — Сэтгүүл захиалгын менежер', loc: LOC },
      { time: '13:30', title: 'Хиймэл оюун ухааныг үр дүнтэй ашиглах нь', desc: 'С.Эрдэнэбат — Стартап Монгол, Айтрип үүсгэн байгуулагч', loc: LOC },
      { time: '', title: 'BARILGA.MN-д хиймэл оюун ухаан нэвтрүүлэх нь', desc: '', loc: LOC },
      { time: '14:45', title: 'Ногоон барилгын дараагийн үе: BIPV технологи ба эрчим хүчний үр ашиг', desc: 'С.Болорбайгаль — BIPV Glass технологийн сургагч багш', loc: LOC },
      { time: '15:05', title: 'Барилгачин худалдааны төвийн танилцуулга', desc: 'С.Түвшинбаяр — Барилгачин групп ХХК, ерөнхий менежер', loc: LOC },
    ],
  },
  {
    id: 'd3',
    ...
    events: [
      ...
      { time: '11:25', title: 'Ногоон барилгын шийдэл: Эрчим хүчний үр ашиг ба барилгын ашиглалтын зардал', desc: 'Ц.Батгэрэл — Ногоон барилгын хүрээлэнгийн гүйцэтгэх захирал', loc: LOC },
      { time: '', title: 'BARILGA.MN-д хиймэл оюун ухаан нэвтрүүлэх нь', desc: '', loc: LOC },
      { time: '13:55', title: 'Нарны эрчим хүч ба барилга: Өөрийн хэрэглээний эрчим хүчээ үйлдвэрлэх боломж', desc: 'Г.Бат-Эрдэнэ — "Монкабель системс" ХХК-ийн Барилгын технологийн хэлтсийн захирал', loc: LOC },
      { time: '14:20', title: 'Халаалтын зардлыг тэглэх боломжтой юу? Өөрийн эрчим хүчээр дулаанаа шийдэх нь', desc: 'Б.Мөнхбаяр — ШУТИС-ийн Барилгын эрчим хүч хэмнэлтийн төвийн захирал', loc: LOC },
