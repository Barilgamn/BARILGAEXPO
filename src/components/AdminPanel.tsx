                ...
                {data.sponsors.map(sponsor => (
                  <div key={sponsor.id} className="flex gap-4 items-center bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      <input type="text" value={sponsor.url || ''} onChange={e => updateSponsor(sponsor.id, 'url', e.target.value)} placeholder="Вэбсайт линк (https://...)" className="w-full border border-gray-300 rounded px-3 py-2" />
